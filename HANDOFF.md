...
- **Decisions:** Webhook de la nueva hoja de Google Sheets conectado en producción. Barra superior y badges de la Versión 4.0 destacados permanentemente en la cabecera. Horario del taller fijado en 20:00 a 21:30 hrs (GMT-4 Santiago). Reemplazo de marca genérica por iniciales de autoría `J.U`.
- **Commits:** `c6a747a`, `bc702eb`, `87401a1`, `c261121`, `2fd0190` (desplegado en `master` y `gh-pages`).
