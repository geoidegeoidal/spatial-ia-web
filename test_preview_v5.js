...
assert.ok(!/script\.google\.com|mpago\.la|paypal\.com/.test(html));
...
console.log('V5 Hydra: content structure, full syllabus, profile/photo, dates/prices, closed registration, assets, anchors and analytics OK');
