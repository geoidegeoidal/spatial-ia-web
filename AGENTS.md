...
- **V5 rendering:** Software-rendered Edge fell to ~20 FPS with animated atlas/orbit and blending; final local version measures ~60 FPS with static atlas/orbit, no blend/blur filters or atmosphere parallax. Preserve floating hands and transform/opacity reveals. Grain uses embedded static SVG; former external noise URL returned 404. Exact user freeze not reproduced on hardware-accelerated Edge.
